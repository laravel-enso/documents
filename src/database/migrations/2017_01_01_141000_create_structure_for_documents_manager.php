...
class CreateStructureForDocumentsManager extends StructureMigration
{
    ...
    protected $permissions = [
        ['name' => 'core.documents.store', 'description' => 'Upload documents', 'type' => 1, 'default' => false],
        ['name' => 'core.documents.index', 'description' => 'List documents for documentable', 'type' => 0, 'default' => false],
        ['name' => 'core.documents.link', 'description' => 'Get document download temporary link', 'type' => 0, 'default' => false],
